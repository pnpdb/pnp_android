...
//		this.paint.setColor(lineColor);
		...
		arrayOfFloat[0] = Utils.dip2px(getContext(), 2.0F);
		arrayOfFloat[1] = Utils.dip2px(getContext(), 2.0F);
		arrayOfFloat[2] = Utils.dip2px(getContext(), 2.0F);
		arrayOfFloat[3] = Utils.dip2px(getContext(), 2.0F);
		this.pe = new DashPathEffect(arrayOfFloat, Utils.dip2px(getContext(),
				1.0F));
	}
