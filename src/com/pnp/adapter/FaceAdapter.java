...
public class FaceAdapter extends BaseAdapter {
	...
	public FaceAdapter(Context context, int currentPage) {
		...
		mFaceMap = MotionUtils.getFaceMap();
		initData();
	}
	...
	@Override
	public int getCount() {
		return PreferenceConstants.NUM + 1;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == PreferenceConstants.NUM) {
			viewHolder.faceIV.setImageResource(R.drawable.emotion_del_selector);
			viewHolder.faceIV.setBackgroundDrawable(null);
			// viewHolder.faceIV.setBackground(null);
		} else {
			int count = PreferenceConstants.NUM * currentPage + position;
			if (count < 107) {
