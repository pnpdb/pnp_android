...
public class AlbumDBAdapter {
	 ...
	 * create table SQL
	 */
	private static final String DATABASE_CREATE = "create table thumbnails (_id integer primary key autoincrement, "
	 ...
	 */
	public AlbumDBAdapter(Context ctx) {
		this.context = ctx;
	...
	public long insertImage(String name, String albums, String path, Bitmap image) {
		...
		if (AlbumUtil.saveBitmap(albums + "_" + name, image)) {
			// other's thing
	...
	public Cursor getAllImages() {
		return db.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_NAME, KEY_ALBUMS, KEY_PATH },
	...
	public Bitmap getImageById(int id) throws SQLException {
		...
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] { KEY_IMAGE }, KEY_ROWID + "="
	...
	public Cursor getImageByAlbum(String albums) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] { KEY_NAME, KEY_ROWID,
				KEY_PATH, KEY_IMAGE }, KEY_ALBUMS + "='" + albums + "'", null, null, null, null,
				null);
		return mCursor;
	}
