...
public class AlbumUtil {
	...
	public static HashMap<String, LinkedList<String>> getAlbumsInfo(int id,
			Cursor cursor) {
	...
	public static Bitmap getFitSizePicture(File f) {
		Log.i(TAG,
				"code come to getFitSizePicture, the file name=" + f.getName()
						+ "; the path=" + f.getAbsolutePath());
	...
	public static LinkedList<ImageModel> getImageInOneAlbum(Resources res,
			String[] pathArrary) {
		LinkedList<ImageModel> images = new LinkedList<ImageModel>();
